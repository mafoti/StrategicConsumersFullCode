...
void trainer::training(){
	...
	/*m(0) = -2;
	cout << "Predicted price for windspeed change -2  is : " << test(m) << endl;
	m(0) = -1;
	cout << "Predicted price for windspeed change -1  is : " << test(m) << endl;
	m(0) = 0;
	cout << "Predicted price for windspeed change 0  is : " << test(m) << endl;
	m(0) = 0.25;
	cout << "Predicted price for windspeed change 0.25  is : " << test(m) << endl;
	m(0) = 0.5;
	cout << "Predicted price for windspeed change 0.5  is : " << test(m) << endl;
	m(0) = 0.75;
	cout << "Predicted price for windspeed change 0.75  is : " << test(m) << endl;
	m(0) = 1;
	cout << "Predicted price for windspeed change 1  is : " << test(m) << endl;
	m(0) = 2;
	cout << "Predicted price for windspeed change 2  is : " << test(m) << endl;
	m(0) = 3;
	cout << "Predicted price for windspeed change 3  is : " << test(m) << endl;
	m(0) = 4;
	cout << "Predicted price for windspeed change 4  is : " << test(m) << endl;*/
...
double trainer::getresult(){
	...
	//double variation = windVariation(simulationId);
	//double windresult1 = wind(simulationId);
	double windresult = wind(simulationId-1);
	//double solarflux = solar(simulationId-1);
	//double windresult1 = wind(simulationId-1);
	//double windresult2 = wind(simulationId-2);
